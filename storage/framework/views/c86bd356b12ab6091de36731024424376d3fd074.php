<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item <?php if ($title === 'Data Barang') { echo 'active'; } ?>">
    <a class="nav-link" href="<?php echo e(route('data_barang')); ?>">
      <i class="fas fa-fw fa fa-shopping-bag"></i>
      <span>Data Barang</span></a>
  </li>

  <li class="nav-item <?php if ($title === 'Kategori') { echo 'active'; } ?>">
    <a class="nav-link" href="<?php echo e(route('data_kategori')); ?>">
...
</ul><?php /**PATH C:\xampp\htdocs\shop_app\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>